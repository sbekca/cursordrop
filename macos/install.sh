...
# Reset permissions (binary hash changes on rebuild)
tccutil reset Accessibility com.cursordrop.app 2>/dev/null
tccutil reset ListenEvent com.cursordrop.app 2>/dev/null
info "Permissions reset"
...
echo "======================================"
echo ""
echo "  ⚠  IMPORTANT: Grant these 2 permissions to make it work:"
echo ""
echo "  1. ACCESSIBILITY"
echo "     macOS should prompt you now. If not:"
echo "     System Settings → Privacy & Security → Accessibility"
echo "     → find CursorDrop → toggle ON"
echo ""
echo "  2. INPUT MONITORING"
echo "     System Settings → Privacy & Security → Input Monitoring"
echo "     → click + → navigate to ~/Applications/CursorDrop.app → Add"
echo "     → toggle ON"
echo ""
echo "     (This is required to paste paths into Cursor's terminal)"
echo ""

# Try to open System Settings to Accessibility pane
sleep 2
open "x-apple.systempreferences:com.apple.preference.security?Privacy_Accessibility" 2>/dev/null
info "Opened Accessibility settings — add CursorDrop and toggle ON"

echo "  After granting permissions, drop a file onto the pill to test."
echo ""
echo "  Usage:"
